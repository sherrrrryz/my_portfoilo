...
/* Nav "back" link for the case-study landing. Returns the visitor wherever
   they came from instead of always dumping them on the homepage: history
   .back() when the previous entry is provably ours, the referrer path when
   they arrived by a hard navigation, /projects otherwise (direct hit, new
   tab, reload). Duplicated per page, same as ThemeToggle (isolation rule:
   themed pages share tokens.css only, never TSX). */
