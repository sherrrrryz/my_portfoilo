...
/* Light/dark toggle for the MIUI Design System case study. Stateless on
   purpose: the visible icon is swapped by CSS keyed off html[data-theme]
   (see .mds-theme in miui-ds.css), so SSR markup never disagrees with the
